...
const ChangePassword = () => {
    ...
    async function submitHandler(e) {
        ...
        try {
            ...
            const response = await axios.post(`Authentication/change-password`,
                            ...
                            <div className="px-4 py-5 px-md-5">
                                ...
                                <ul className="nav nav-tabs d-flex justify-content-between p-3" id="myTab" role="tablist">
                                    ...
                                    <Link to="/change-password">
                                        <li className="nav-item" role="presentation">
                                            <p className="nav-link active" id="password-tab" data-bs-toggle="tab" data-bs-target="#password-tab-pane" type="button" role="tab" aria-controls="password-tab-pane" aria-selected="false">Password </p>
                                        </li>
                                    </Link>
                                ...
                                <div className="card col-lg-6 ms-auto me-auto bg-glass">
                                    <div className="card-body px-4 py-5 px-md-5">
                                        ...
                                        <form className="form" onSubmit={submitHandler}>
                                            <h4 className="fw-normal text-center mb-3 pb-3" style={{ letterSpacing: '1px' }}>Change Password</h4>
