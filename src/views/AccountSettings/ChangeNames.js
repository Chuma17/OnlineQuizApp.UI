                                ...
                                <ul className="nav nav-tabs d-flex justify-content-between p-3" id="myTab" role="tablist">
                                    ...
                                    <Link to="/change-names">
                                        <li className="nav-item" role="presentation">
                                            <p className="nav-link active" id="names-tab" data-bs-toggle="tab" data-bs-target="#names-tab-pane" type="button" role="tab" aria-controls="names-tab-pane" aria-selected="true"> Names </p>
                                        </li>
                                    </Link>
