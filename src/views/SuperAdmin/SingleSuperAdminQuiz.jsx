                                                ...
                                                <div className="d-flex details justify-content-between">
                                                    <div className="col-md-5 ms-0">
                                                        ...
                                                        <div className="d-flex justify-content-between">
                                                            ...
                                                            <Link to={`/view-superAdmin-questions-in-quiz/${id}?adminId=${adminId}`}><button className="btn btn-dark mb-3"><i className="fa-solid fa-gear text-light"></i></button></Link>
                                                        </div>
...
export default SingleSuperAdminQuiz;